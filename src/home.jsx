            ...
            <div className="w-[90%] mx-auto  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                <div className="h-[100vh] flex justify-between items-center">
                    <div className="flex flex-col gap-4 p-[10px]">
                        ...
                        <a href="https://drive.google.com/file/d/1P_W5_M-1N3TgVrkr--f1gZoeu7rhwGi5/view"><button className="text-[16px] font-[500px] text-[#FFFFFF] leading-[24px] bg-[#6244c5] font-[poppins] p-[10px] rounded-xl w-[200px]">Download CV</button></a>
                    </div>
                </div>
                <div>
                    <div className="ml-16">
